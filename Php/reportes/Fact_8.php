...
// ---------------INICIO DEL REPORTE-----------------
	$sql = "SELECT 
                ...
                f.venta_total,f.iva,f.iva_retenido,peso,nbultos,wr,hawb,mawb,sal,hbol
                FROM facturacion f 
       ...
       //style="border:solid 1px"
        ...
        $datos_factura='<br>
            ...
            <tr>
             ...
             <tr>
               ...
               <td style="text-align:center" width="100px">'. $rows_e["peso"] .'</td> 
            </tr>
			<tr>
                <td style="text-align:center;font-size:8pt" colspan="4">&nbsp;</td>
                <td colspan="2" height="0px">&nbsp;</td>
            </tr>
            <tr>
                <td style="text-align:center;font-size:8pt" colspan="4">'.strtoupper($rows_e["direccion"]).'</td>
                <td  height="0px">&nbsp;</td>
				<td  height="0px">'.strtoupper($rows_e["hbol"]).'</td>
            </tr>
             <tr>
                <td  >&nbsp;</td>
                <td style="text-align:left"  colspan="4" >'.strtoupper($rows_e["venta_acta_de"]).'</td>
				<td style="text-align:left" >SAL '.strtoupper($rows_e["sal"]).'</td>
            </tr>
        ...
        //ESTA ES LA PARTE QUE CONTIENE EL TOTAL EN LETRAS Y SUS DESGLOSES
          $pie_factura='</table></td></tr>
                     <tr><td colspan="6" height="30px"></td></tr>
