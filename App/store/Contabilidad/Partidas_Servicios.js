		Ext.define('MvcClientes.store.Contabilidad.Partidas_Servicios', {
		extend: 'Ext.data.Store',
                model: 'MvcClientes.model.Contabilidad.Partidas_Servicios',//Llamamos el Modelo Antes Creado
		...
		proxy: {
            ...
            api: { //Declaramos la API y Comienzan en estas lineas las operaciones CRUD
				 read    : "Php/view/Contabilidad/Partidas_Servicios/Partidas_ServiciosRead.php",
				 create  : "Php/view/Contabilidad/Partidas_Servicios/Partidas_ServiciosCreate.php",
				 update  : "Php/view/Contabilidad/Partidas_Servicios/Partidas_ServiciosUpdate.php",
				 destroy : "Php/view/Contabilidad/Partidas_Servicios/Partidas_ServiciosDestroy.php"
			},
			/*actionMethods:{
			    read:'POST'
			},*/
            reader: {
                type: 'json',
				idProperty: 'id_partidas_servicios',
					...
					if (request.action == 'read')
					    ...
					    if (request.action == 'destroy')
						{
							 if(Ext.decode(request.callback.arguments[2].responseText).success){
                                                        ...
                                                        Ext.Msg.alert('Mensaje','Error al eliminar: Partida Asociada a un Servicio');
                                                    }   
					    }
                        },
			listeners: {
